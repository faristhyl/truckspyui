...
export class AdminLocationsComponent implements OnInit {
  ...
  addMapboxDraw() {
    ...
    if (this.activeGroup && this.theMapInstance) {
  ...
  createLocation(e) {
    ...
    this.restService.createAdminLocation(locationData)
      .subscribe(
  ...
  updateLocation(data: any) {
    ...
    this.restService.updateAdminLocation(updateData)
      .subscribe(
        updated => {
  ...
  onGroupChange(groupId): void {
    ...
    this.activeGroup = this.globalGroups.find(group => group.id === this.groupId);
    this.addMapboxDraw();
  ...
  deleteLocation(locationId) {
    this.restService.deleteAdminLocation(locationId)
      .subscribe(
        good => {
  ...
  doEditLocation() {
    ...
    this.restService.updateAdminLocation(this.locationData)
      .subscribe(
        updated => {
          const index = this.locations.findIndex(
            location => location.id === locationId
  ...
  /**
   * Constructor to instantiate an instance of AdminLocationsComponent.
   */
  constructor(
  ...
  ngOnInit() {
    ...
    this.restService.get1000AdminLocationGroups()
      .subscribe(
        data => {
          this.globalGroups = data;

          this.activeGroup = this.globalGroups.find(group => group.id === this.groupId) || this.globalGroups[0];
