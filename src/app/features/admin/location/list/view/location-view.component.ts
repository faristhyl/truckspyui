...
@Component({
  selector: 'app-admin-location-view',
  templateUrl: './location-view.component.html',
  styleUrls: ['./location-view.component.css']
})
export class AdminLocationViewComponent implements OnInit {
  ...
  /**
   * Constructor to instantiate an instance of AdminLocationViewComponent.
   */
  constructor(
  ...
  ngOnInit() {
    ...
    this.restService.getAdminLocation(this.locationId)
      .subscribe(result => {
