...
@Component({
  selector: 'app-vehicle-devices',
  templateUrl: './vehicle-devices.component.html',
  styleUrls: ['./vehicle-devices.component.css']
})
export class VehicleDevicesComponent implements OnInit {
  ...
  /**
   * Constructor to instantiate an instance of VehicleDevicesComponent.
   */
  constructor(
  ...
  loadData() {
    combineLatest(
      ...
      this.restService.get1000DevicesForVehicle(this.vehicleId)
    ).subscribe(data => {
