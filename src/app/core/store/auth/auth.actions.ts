...
export enum AuthActionTypes {
  ...
  LoggedInAs = "[Auth] Logged In As",
  LoggedOutAs = "[Auth] Logged Out As"
}
...
export class LoggedInAs implements Action {
  readonly type = AuthActionTypes.LoggedInAs;
}
export class LoggedOutAs implements Action {
  readonly type = AuthActionTypes.LoggedOutAs;
}
