...
import { User } from '../../services/rest.model';
import { AuthTokenService } from '../../services/auth-token.service';
import { LocalStorageService } from '../../services/rest.service';
...
export class AuthEffects {
  ...
  authRedirect$ = this.actions$.pipe(
    ...
    tap((data: any) => {
      let user: User = plainToClass(User, data.payload as User);
